...
public class CalendarView extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        params.setMargins(mDelegate.getMonthViewLeftMargin(), mDelegate.getWeekBarHeight() + mDelegate.getMonthViewTopMargin(), mDelegate.getMonthViewRightMargin(), mDelegate.getMonthViewBottomMargin());
