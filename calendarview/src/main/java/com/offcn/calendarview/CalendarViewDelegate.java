...
final class CalendarViewDelegate {
     ...
     * 月视图的顶边距
     */
    private int mMonthViewTopMargin;
    /**
     * 月视图的底边距
     */
    private int mMonthViewBottomMargin;
    /**
     * 月视图的左边距
     */
    private int mMonthViewLeftMargin;
    /**
     * 月视图的右边距
     */
    private int mMonthViewRightMargin;
    ...
    CalendarViewDelegate(Context context, @Nullable AttributeSet attrs) {
        ...
        // 月视图本身相关
        mMonthViewTopMargin = (int) array.getDimension(R.styleable.CalendarView_month_view_top_margin, CalendarUtil.dipToPx(context, 1));
        mMonthViewBottomMargin = (int) array.getDimension(R.styleable.CalendarView_month_view_bottom_margin, 0);
        mMonthViewLeftMargin = (int) array.getDimension(R.styleable.CalendarView_month_view_left_margin, 0);
        mMonthViewRightMargin = (int) array.getDimension(R.styleable.CalendarView_month_view_right_margin, 0);
...
//        }
    ...
    int getMonthViewTopMargin() {
        return mMonthViewTopMargin;
    }

    int getMonthViewBottomMargin() {
        return mMonthViewBottomMargin;
    }

    int getMonthViewLeftMargin() {
        return mMonthViewLeftMargin;
    }

    int getMonthViewRightMargin() {
        return mMonthViewRightMargin;
    }
